...
public class WaterFragment extends Fragment {
    ...
    private BarChart barChart;  // Initialize BarChart
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Find the BarChart
        barChart = view.findViewById(R.id.barChart2);  // Initialize BarChart
        ...
        ImageView vectorImageView = view.findViewById(R.id.vector2);
        ...
        // TODO: Fetch water usage data from Firebase Realtime Database
    ...
    private void setupBarChart(List<BarEntry> entries) {
        BarDataSet barDataSet = new BarDataSet(entries, "Water Consumption");
        BarData barData = new BarData(barDataSet);
        barChart.setData(barData);
        barChart.setTouchEnabled(true);
        int BlueColor = ContextCompat.getColor(requireContext(), R.color.add_new_card_ek2_color);

        barDataSet.setColor(BlueColor);
